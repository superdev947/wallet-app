...
const WalletCreateScreen = ({ navigation }) => {
    const [modalReceived, setModalReceived] = useState(true)
        ...
        <Container style={[S.BKBlack]}>
            <Content contentContainerStyle={[S.PV20]}>
                <View style={[S.ROW, S.Jbetween, S.Acenter, S.PH20]}>
                    ...
                    <Text style={[S.F20, S.CLW, S.FW700]}> Portfolio </Text>
                ...
                <View style={[S.Acenter]}>
                    ...
                    <Text style={[S.F15, S.CLW, S.FW400]}> Wallet Balance </Text>
                </View>
                ...
                <View style={[S.ROW, S.Jaround, S.PH20]}>
                    <View style={[S.Acenter]}>
                        <TouchableOpacity style={[S.P10, S.BKBase, S.BorderRadius5, S.AScenter]} onPress={() => setModalAddToken(!modalAddToken)}>
                            <Icon type="Feather" name="plus-circle" style={[S.CLW, S.F24]} />
                        </TouchableOpacity>
                        <Text style={[S.MT5, S.F14, S.CLW, S.FW400]}>Add Token</Text>
                    </View>
                    <View style={[S.Acenter]}>
                        ...
                        <Text style={[S.MT5, S.F14, S.CLW, S.FW400]}>Withdraw</Text>
                    </View>
                    <View style={[S.Acenter]}>
                        ...
                        <Text style={[S.MT5, S.F14, S.CLW, S.FW400]}>Send</Text>
                    </View>
                    <View style={[S.Acenter]}>
                        ...
                        <Text style={[S.MT5, S.F14, S.CLW, S.FW400]}>Swap</Text>
                    </View>
                </View>
            ...
            <BottomModal
                setModalVisible={setModalReceived}
                modalVisible={modalReceived}
                title={'Received'}
                content={
                    <Fragment>
                        <View style={[S.Acenter]}>
                            <Image source={Images.Profile} style={{ width: normalize(40), height: normalize(40) }} resizeMode='contain' />
                            <Text style={[S.F14, S.CLW]}> Alexis J. </Text>
                            <Text style={[S.F14, S.CLW]}> 555-778-9632 </Text>
                        </View>
                        <Text style={[S.F19, S.CLW, S.Tcenter, S.MV20]}> {`Hey, thank you for getting that \norder for me!`} </Text>
                        <View style={{ borderWidth: StyleSheet.hairlineWidth, borderColor: '#fff' }} />
                        <View style={[S.PH20]}>
                            <Text style={[S.F15, S.CLW, S.FW400, S.MT20]}> Amount </Text>
                            <Text style={[S.F19, S.CLW, S.FW700, S.MT5]}> 0.00965 BTC </Text>
                            <Text style={[S.F15, S.CLW, S.FW400, S.MT20]}> Amount ($) </Text>
                            <Text style={[S.F19, S.CLW, S.FW700, S.MT5]}> $103.24 </Text>
                            <Text style={[S.F15, S.CLW, S.FW400, S.MT20]}> Available after confirmation </Text>
                            <Text style={[S.F19, S.CLW, S.FW700, S.MT5]}> $4.513,22 </Text>
                            <Button vertical style={[S.PH50, S.BKBase, S.AScenter, S.MV20]}>
                                <Text style={[S.F16, S.CLW, S.FW700]}> Accept </Text>
                            </Button>
                        </View>
                    </Fragment>
                }
            />
            <BottomModal
                setModalVisible={setModalAddToken}
                modalVisible={modalAddToken}
                title={'Add Token'}
                content={
                    <View>
                        <View style={[S.ROW, S.PH30]}>
                            <TouchableOpacity style={[S.PR20, S.PB10]}>
                                <Text style={[S.F14, S.CLW]}> Search </Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[S.PB10]}>
                                <Text style={[S.F14, S.CLWarning]}> Custom Token </Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{ borderWidth: StyleSheet.hairlineWidth, borderColor: '#fff' }} />
                        <View style={[S.PH30, S.MT20]}>
                            <Text style={[S.F15, S.CLW]}> Token Contract Adress </Text>
                            <TextInput
                                value='3M8w2knJKsr3jqMatYiyuraxVvZA'
                                style={S.textInput}
                            />
                            <View style={[S.ROW, S.Jbetween, S.MT20]}>
                                <Text style={[S.F15, S.CLW]}> Token Symbol </Text>
                                <TouchableOpacity>
                                    <Text style={[S.F15, S.CLWarning]}> Edit </Text>
                                </TouchableOpacity>
                            </View>
                            <TextInput
                                placeholder='MKR'
                                ...
                                style={S.textInput}
                            />
                            <Text style={[S.F15, S.CLW, S.MT20]}> Decimals of Precision </Text>
                            <TextInput
                                value='16'
                                style={S.textInput}
                            />
                            <View style={[S.ROW, S.PV20, S.Jaround]}>
                                <Button vertical bordered style={[S.PH40, S.AScenter, { borderColor: COLOR.base }]}>
                                    <Text style={[S.F16, S.CLW, S.FW400]}> Cancel </Text>
                                </Button>
                                <Button vertical style={[S.PH40, S.BKBase, S.AScenter]}>
                                    <Text style={[S.F16, S.CLW, S.FW400]}> Accept </Text>
                                </Button>
                            </View>
                        </View>
                    </View>
